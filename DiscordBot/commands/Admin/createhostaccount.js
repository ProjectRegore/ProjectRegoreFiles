...
module.exports = {
    commandInfo: {
        ...
        description: "Creates a host account for Regore Backend."
    },
    execute: async (interaction) => {
        ...
        const existingHostAccount = await User.findOne({ email: "hostaccount@regorebackend.com" });
        ...
        const username = "regorebackendhostaccount";
        const email = "hostaccount@regorebackend.com";
        ...
        try {
            await functions.registerUser(null, username, email, password).then(async (resp) => {
                let embed = new MessageEmbed()
                    ...
                    .setFooter({
                        text: "Regore Backend",
                        iconURL: "https://i.imgur.com/247nYNl.png"
                    });
